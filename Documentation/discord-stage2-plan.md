...
- The injected line shows the injecting player as the game-level sender (`InjectorName: [Discord] bob: hi`); which member's name appears varies with who claimed. Cosmetic; guilds will know the convention.
